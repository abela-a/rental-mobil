...
if (!isset($_SESSION['Login'])) {
  ...
  if ($_SESSION['Login']['RoleId'] !== '2' && $_SESSION['Login']['RoleId'] !== '1') {
    Flasher::setFlash('Anda bukan karyawan', 'danger');
  ...
  <div class="col-lg-3 shadow">
    <div class="sidebar">
      ...
      <div id='user' class="collapse mx-4">
        <div class="row no-gutters p-1">
          <div class="col-md m-1">
            <a href="<?= BASEURL; ?>/karyawan/userProfile/<?= $_SESSION['Login']['Id'] ?>" class="btn bg-back btn-block">
      ...
      <div class="mt-3 accordion" id="menu-coll">
        <!-- DASHBOARD -->
        <a href="<?= BASEURL; ?>/karyawan" class="btn-main <?php if ($data['judul'] == 'Dashboard') echo 'btn-main-active'; ?>">
          <i class="fas fa-tachometer-alt fa-fw mr-3"></i>
          <span class="text-menu">Dashboard</span>
        </a>
        <hr class="my-2 mx-4">
        <!-- TRANSAKSI -->
        <a href="<?= BASEURL; ?>/karyawan/transaksi" class="btn-main <?php if ($data['judul'] == 'Transaksi') echo 'btn-main-active'; ?>">
        ...
        <div id='kendaraan' class="collapse bg-white rounded <?php if ($data['judul'] == 'Merk' || $data['judul'] == 'Tipe' || $data['judul'] == 'Mobil') echo 'show'; ?>" data-parent="#menu-coll">
          <a href="<?= BASEURL; ?>/karyawan/merk" class="btn-main <?php if ($data['judul'] == 'Merk') echo 'btn-main-active'; ?>">
            <i class="fas fa-fw mr-3"></i>
            <span>Merk</span>
          </a>
          <a href="<?= BASEURL; ?>/karyawan/type" class="btn-main <?php if ($data['judul'] == 'Tipe') echo 'btn-main-active'; ?>">
            <i class="fas fa-fw mr-3"></i>
            <span>Tipe</span>
          </a>
          <a href="<?= BASEURL; ?>/karyawan/mobil" class="btn-main <?php if ($data['judul'] == 'Mobil') echo 'btn-main-active'; ?>">
            <i class="fas fa-fw mr-3"></i>
            <span>Mobil</span>
          </a>
        </div>
        ...
        <div id='akun' class="collapse bg-white rounded <?php if ($data['judul'] == 'Karyawan' || $data['judul'] == 'Pelanggan' || $data['judul'] == 'Sopir') echo 'show'; ?>" data-parent="#menu-coll">
          <a href="<?= BASEURL; ?>/karyawan/pelanggan" class="btn-main <?php if ($data['judul'] == 'Pelanggan') echo 'btn-main-active'; ?>">
            <i class="fas fa-fw mr-3"></i>
            <span>Pelanggan</span>
          </a>
          <a href="<?= BASEURL; ?>/karyawan/sopir" class="btn-main <?php if ($data['judul'] == 'Sopir') echo 'btn-main-active'; ?>">
            <i class="fas fa-fw mr-3"></i>
            <span>Sopir</span>
          </a>
        </div>
