...
<div class="row">
  ...
  <div class="col-md-12">
    <button class="btn btn-primary mb-3" type="button" data-toggle="modal" data-target="#inputType">
      <i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Tipe Mobil
    </button>
  </div>
</div>
    ...
    foreach ($data['type'] as $type) : ?>
      ...
      <tr>
        ...
        <td class="text-center">
          <button class="btn btn-warning" data-toggle="modal" data-target="#edit<?= $type['IdType']; ?>"><i class="fas fa-fw fa-edit"></i></button>
          <button class="btn btn-danger" data-toggle="modal" data-target="#hapus<?= $type['IdType']; ?>"><i class="fas fa-fw fa-trash"></i></button>
        </td>
      </tr>
